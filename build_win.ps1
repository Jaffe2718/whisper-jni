...
cmake -B build -DCMAKE_INSTALL_PREFIX=src/main/resources/win-amd64 -DBUILD_SHARED_LIBS=0 -DGGML_STATIC=1 -DGGML_CUDA=ON -DCMAKE_CUDA_ARCHITECTURES="61;75;86;89"
cmake --build build --config Release
cmake --install build
rm -r -fo build
...
#cmake -B build -DCMAKE_INSTALL_PREFIX=src/main/resources/win-amd64 -DBUILD_SHARED_LIBS=0 -DGGML_STATIC=1 -DGGML_VULKAN=1
